...
function MusicSchoolContactUs() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-20  relative">
      ...
      <BackgroundBeams className="absolute top-0 left-0 w-full h-full z-0" />
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        <h1 className="h1-contact text-lg md:text-7xl sm:text-10xl text-center font-sans font-bold mb-8 text-orange">
          Contact Us
        </h1>
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center">
          We are here to help with any questions about our courses, programs, or events.
