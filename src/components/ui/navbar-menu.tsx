...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="class relative rounded-full border border-transparent dark:bg-black dark:border-white/[0.2] shadow-input flex justify-center space-x-4 px-4 py-2 "
    >
      {children}
    </nav>
  );
